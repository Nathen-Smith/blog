...
function PostCard({ id, title, estimatedTime, date }: PostCardProps) {
  return (
    <Link href={`/posts/${id}`}>
      <div className="-mx-2 cursor-pointer px-2 transition-all dark:rounded-md sm:mx-0 sm:min-h-[128px] sm:rounded-lg sm:border sm:py-6 sm:pt-4 dark:sm:-mx-2 dark:sm:border-0 dark:sm:bg-zinc-900 dark:sm:py-4 lg:min-h-[128px] lg:p-4 lg:pt-6 lg:pb-10 lg:hover:scale-105 lg:hover:border-2 lg:hover:border-indigo-500 dark:lg:min-h-[112px] dark:lg:p-2 dark:lg:hover:scale-100 dark:lg:hover:border-0 dark:lg:hover:bg-zinc-800">

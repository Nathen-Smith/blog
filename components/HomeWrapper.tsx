  ...
  return (
    <div className="drawer">
      ...
      <div className="drawer-content flex flex-col bg-white transition-colors duration-300 dark:bg-zinc-900 lg:text-lg 2xl:text-xl">
        <Navbar />
        <div className="prose prose-zinc mx-auto w-full max-w-[65ch] px-[14px] pt-8 transition-colors duration-300 dark:prose-invert sm:px-0 lg:prose-lg 2xl:prose-xl 2xl:pt-12">
          {children}
        </div>
        <Footer />
      </div>

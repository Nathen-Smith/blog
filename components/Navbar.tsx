...
export default function NavBar() {
  return (
    <div className="navbar mx-auto w-full max-w-[65ch] bg-white px-0 transition-colors dark:bg-zinc-900 dark:text-white sm:bg-transparent sm:dark:bg-transparent">
